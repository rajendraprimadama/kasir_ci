            ...
            <div class="col-md-6 col-sm-6 col-xs-6">
              <fieldset>
                ...
                <div class="input-group form-group">
                  ...
                  <input type="text" class="form-control FormatKey text-right sell_update v_pcs_hrgjual_retail_update" data-category="pcs" placeholder="Harga jual pcs retail" name="v_pcs_hrgjual_retail" aria-describedby="sizing-addon2" maxlength="10" value="<?php echo $dataBarang->pcs_hrgjual_retail; ?>">
                </div>
                ...
                <div class="input-group form-group">
                  ...
                  <input type="text" class="form-control FormatKey text-right sell_update v_pax_hrgjual_retail_update" data-category="pax" placeholder="Harga jual pax retail" name="v_pax_hrgjual_retail" aria-describedby="sizing-addon2" maxlength="10" value="<?php echo $dataBarang->pax_hrgjual_retail; ?>">
                </div>
                ...
                <div class="input-group form-group">
                  ...
                  <input type="text" class="form-control FormatKey text-right sell_update v_dus_hrgjual_retail_update" data-category="dus" placeholder="Harga jual dus retail" name="v_dus_hrgjual_retail" aria-describedby="sizing-addon2" maxlength="10" value="<?php echo $dataBarang->dus_hrgjual_retail; ?>">
                </div>
            </fieldset>
            </div>
            ...
            <div class="col-md-6 col-sm-6 col-xs-6">
              <fieldset>
                ...
                <div class="input-group form-group">
                  ...
                  <input type="text" class="form-control FormatKey text-right sell_update v_pcs_hrgjual_grosir_update" data-category="pcs" placeholder="Harga jual pcs grosir" name="v_pcs_hrgjual_grosir" aria-describedby="sizing-addon2" maxlength="10" value="<?php echo $dataBarang->pcs_hrgjual_grosir; ?>">
                </div>
                ...
                <div class="input-group form-group">
                  ...
                  <input type="text" class="form-control FormatKey text-right sell_update v_pax_hrgjual_grosir_update" data-category="pax" placeholder="Harga jual pax grosir" name="v_pax_hrgjual_grosir" aria-describedby="sizing-addon2" maxlength="10" value="<?php echo $dataBarang->pax_hrgjual_grosir; ?>">
                </div>
                ...
                <div class="input-group form-group">
                  ...
                  <input type="text" class="form-control FormatKey text-right sell_update v_dus_hrgjual_grosir_update" data-category="dus" placeholder="Harga jual dus grosir" name="v_dus_hrgjual_grosir" aria-describedby="sizing-addon2" maxlength="10" value="<?php echo $dataBarang->dus_hrgjual_grosir; ?>">
                </div>
              </fieldset>
            </div>
