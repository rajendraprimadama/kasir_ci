					...
					<table>
						...
						<tr>
							<td style="width:200px;"></th>
								...
								<td><input type="text" name="satuan" value="<?php echo 'PCS';?>" style="width:120px;margin-right:5px;" class="form-control input-sm" readonly></td>
								<td><input type="text" name="harjul" value="<?php echo number_format($b['pcs_hrgjual_retail']);?>" style="width:120px;margin-right:5px;text-align:right;" class="form-control input-sm" readonly></td>
